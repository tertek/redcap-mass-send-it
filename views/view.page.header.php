    ...
    <div id="sub-nav" class="d-none d-sm-block" style="margin:5px 0 15px;width:950px;">
        <ul>
            <li<?php echo (!isset($_GET['log']) ? ' class="active"' : '') ?>>
                <a href="<?php echo $this->getUrl('project-page.php') ?>" style="font-size:13px;color:#393733;padding:6px 12px 7px 13px;"><i class="fas fa-mail-bulk me-1"></i>My Bulks</a>
            </li>
            <li<?php echo (isset($_GET['log']) ? ' class="active"' : '') ?>>
                <a href="<?php echo $this->getUrl('project-page.php') ?>&log=1" style="font-size:13px;color:#393733;padding:6px 12px 7px 13px;"><i class="fas fa-table me-1"></i>Notification Log</a>
            </li>
        </ul>
    </div>
</div>