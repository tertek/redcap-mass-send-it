    ...
    init() {
        ...
        $('.bulk-delete-btn').on('click', function () {
            ...
            let onConfirm = () => {
                ...
                JSO_STPH_BULK_SEND.ajax("bulk", payload).then((json) => {
        ...
        $('.bulk-schedule-btn').on('click', function (e) {
            ...
            let onConfirm = () => {
                ...
                JSO_STPH_BULK_SEND.ajax("schedule", payload).then((json) => {
                    let response = JSON.parse(json);
